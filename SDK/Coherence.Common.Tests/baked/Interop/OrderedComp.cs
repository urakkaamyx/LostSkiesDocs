...
namespace Coherence.Generated
{
    ...
    public struct OrderedComp : ICoherenceComponentData
    {
        ...
        public static unsafe OrderedComp FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 0) {
        ...
        public static uint Serialize(OrderedComp data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static OrderedComp Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
