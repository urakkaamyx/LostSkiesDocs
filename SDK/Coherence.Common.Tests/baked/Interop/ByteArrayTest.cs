...
namespace Coherence.Generated
{
    ...
    public struct ByteArrayTest : ICoherenceComponentData
    {
        ...
        public static unsafe ByteArrayTest FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
