...
namespace Coherence.Generated
{
    ...
    public struct IntComponent : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= IntComponent.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe IntComponent FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 17");
            }
        ...
        public static uint Serialize(IntComponent data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static IntComponent Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new IntComponent();
            if (bitStream.ReadMask())
            {

                val.number = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= IntComponent.numberMask;
            }
