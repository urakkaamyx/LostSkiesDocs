...
namespace Coherence.Generated
{
    ...
    public struct FloatComponent : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= FloatComponent.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe FloatComponent FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
        ...
        public static uint Serialize(FloatComponent data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static FloatComponent Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new FloatComponent();
            if (bitStream.ReadMask())
            {

                val.number = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= FloatComponent.numberMask;
            }
