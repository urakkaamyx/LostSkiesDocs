...
namespace Coherence.Generated
{
    ...
    public struct Ordered2Comp : ICoherenceComponentData
    {
        ...
        public static unsafe Ordered2Comp FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 0) {
        ...
        public static uint Serialize(Ordered2Comp data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static Ordered2Comp Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
