...
namespace Coherence.Samples.LobbiesDialog
{
    ...
    public class LobbySessionUI : MonoBehaviour
    {
        ...
        [SerializeField]
        private GameObject lobbiesListObject;
        [SerializeField]
    ...
    internal class PlayersListView
    {
        ...
        public PlayersListView(int capacity = 50) => Views = new(capacity);

        public void SetSource(IReadOnlyList<LobbyPlayer> dataSource, LobbySession lobbySession, Action onKickedPlayer)
        {
            Clear();
        ...
        private LobbySessionPlayersView MakeViewItem(LobbyPlayer data, LobbySession lobbySession)
        {
